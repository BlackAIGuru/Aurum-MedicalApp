...
class Q08Widget extends StatefulWidget {
  const Q08Widget({Key? key}) : super(key: key);

  @override
  _Q08WidgetState createState() => _Q08WidgetState();
}
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 10.0),
                            child: Text(
                              'Does the patient have a trauma history or PTSD symptoms?',
