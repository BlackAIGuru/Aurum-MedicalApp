...
class Q06Widget extends StatefulWidget {
  const Q06Widget({Key? key}) : super(key: key);

  @override
  _Q06WidgetState createState() => _Q06WidgetState();
}
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 10.0),
                            child: Text(
                              'Is the patient experiencing anxiety that interferes with daily life?',
